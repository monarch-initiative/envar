...
!!! note "Work in progress"
    Establishing these partnerships is ongoing. The list below reflects current and prospective collaborations and will evolve as the project progresses.
...
| [CLAD](https://allofus.nih.gov/article/center-for-linkage-and-aquisition-of-data) | Center for Linkage and Acquisition of Data; All of Us environmental linkage |
...
| [GA4GH](https://www.ga4gh.org/) | Human Exposome Data Standards Study Group; Super Spreadsheet minimum-metadata schema |
...
| [Microschema](https://github.com/linkml/linkml-microschema-profile) | LinkML-based CDE specifications for environmental variables |
| [Global Exposome Forum](https://globalexposomeforum.org/) | Exposomics community; ECTO and Monarch KG promotion |
