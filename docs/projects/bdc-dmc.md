...
- Plans to engage [CLAD](clad.md) for geolocation and data linking
- NIEHS data integration discussions with Charles Schmitt
- [Microschema](microschema.md) CDEs planned for the BDC harmonized CDE repository
- Related to the [BDC Data Portal](bdc-portal.md) project
